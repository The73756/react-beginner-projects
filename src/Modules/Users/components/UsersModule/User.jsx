...
export const User = ({ first_name, last_name, id, email, avatar, onclickInvite, isInvited }) => (
  <li>
    <div>
    ...
    <button onClick={() => onclickInvite(id)} className={styles.action}>
      <img src={isInvited ? minus : plus} alt='Action' />
    </button>
  </li>
);
